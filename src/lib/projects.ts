...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    duration: "",
    tags: ["Brand", "Identity"],
    blurb: "Brand identity work — one of the newer projects. Case study in progress.",
    oneLiner: "Brand identity — case study in progress.",
    brief: "TODO: What EverMark is, and what I built for them.",
    process: [],
    services: ["Brand identity"],
    palette: ["#12211c", "#1cb791", "#294a40", "#eef3ef"],
    display: "EVERMARK",
    cover: "",
    gallery: [],
    roleSummary: "TODO: What John led on EverMark.",
    caseStudy: {
      overview: [
        { label: "Client", value: "EverMark" },
        { label: "Role", value: "TODO: Confirm role" },
        { label: "Year", value: "TODO: Confirm" },
        { label: "Scope", value: "Brand identity" },
        { label: "Deliverables", value: "TODO: Confirm" },
      ],
      challenge: "TODO: The problem EverMark needed solved.",
      mandate: "TODO: Why John was brought in and what he owned.",
      context: "TODO: Constraints — stakeholders, timeline, category.",
      role: ["TODO: What John personally did"],
      team: ["TODO: Collaborators, if any"],
      decisions: [
        { title: "TODO: Key decision", body: "TODO: Options, recommendation, tradeoff, result." },
      ],
      outcomes: ["TODO: Confirm outcome"],
  ...
  },
  {
    ...
    client: "Atromitos",
    year: "",
    category: "Web & Report Design",
    duration: "",
    tags: ["Web", "Report", "Design"],
    blurb: "Website plus the Andy Hill report for Atromitos. Case study in progress.",
    oneLiner: "Website and report design — case study in progress.",
    brief: "TODO: What Atromitos is, the website, and the Andy Hill report.",
    process: [],
    services: ["Web design", "Report / editorial design"],
    palette: ["#0e1b2a", "#2b8fb8", "#1f3a5c", "#eef2f6"],
    display: "ATROMITOS",
    cover: "",
    gallery: [],
    roleSummary: "TODO: What John led — website + Andy Hill report.",
    caseStudy: {
      overview: [
        { label: "Client", value: "Atromitos" },
        { label: "Role", value: "TODO: Confirm role" },
        { label: "Year", value: "TODO: Confirm" },
        { label: "Scope", value: "Website + the Andy Hill report" },
        { label: "Deliverables", value: "Website, report" },
      ],
      challenge: "TODO: The problem the website + report needed to solve.",
      mandate: "TODO: Why John was involved and what he owned.",
      context: "TODO: Constraints and stakeholders.",
      role: ["TODO: What John personally did on the website", "TODO: What John did on the Andy Hill report"],
      team: ["TODO: Collaborators"],
      decisions: [
        { title: "TODO: Key decision", body: "TODO: Options, recommendation, tradeoff, result." },
      ],
      outcomes: ["TODO: Confirm outcome"],
  ...
  },
  {
    ...
    client: "TODO: Confirm client",
    year: "",
    category: "Campaign",
    duration: "",
    tags: ["Campaign", "Healthcare", "Members"],
    blurb: "A member campaign now rolling out to thousands. Case study in progress.",
    oneLiner: "A member campaign, just going live — case study in progress.",
    brief: "TODO: What the Important! Colorado campaign is and the goal.",
    process: [],
    services: ["Campaign concept", "Design"],
    palette: ["#2a140e", "#e0703a", "#7a3b22", "#f4ece6"],
    display: "IMPORTANT!",
    cover: "",
    gallery: [],
    roleSummary: "TODO: What John created for the campaign.",
    caseStudy: {
      overview: [
        { label: "Client", value: "TODO: Confirm" },
        { label: "Role", value: "TODO: Confirm role" },
        { label: "Year", value: "2025 (rolling out)" },
        { label: "Scope", value: "Member campaign" },
        { label: "Reach", value: "Thousands of members (launching)" },
      ],
      challenge: "TODO: What the campaign needed to accomplish and for whom.",
      mandate: "TODO: Why John was involved and what he owned.",
      context: "TODO: Constraints — compliance, audience, channels.",
      role: ["TODO: What John personally created"],
      team: ["TODO: Collaborators"],
      decisions: [
        { title: "TODO: Key decision", body: "TODO: Options, recommendation, tradeoff, result." },
      ],
      outcomes: ["TODO: Confirm outcome once the campaign is live"],
      reflection: "TODO: Add a short, honest reflection.",
    },
  },
  {
